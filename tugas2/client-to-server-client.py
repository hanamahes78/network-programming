...
class TestClient(unittest.TestCase): #class yg menginherit class testcase dari modul unittest
...
class NullWriter(StringIO): #mengoutputkan print saja, yg lain jadi 0
    def write(self, txt):
        pass
