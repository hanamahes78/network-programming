...
class TestServer(unittest.TestCase):
    ...
    def test_handle_client_connection(self, mock_socket):
        ...
        mock_client_socket.sendall.assert_called_with(b'Welcome into this client-server-client sending message program!')
        print(f"send called with: {mock_client_socket.sendall.call_args}")
